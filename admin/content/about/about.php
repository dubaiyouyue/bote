...
if($action=="modify"){ 
	...
	if(!$endescription){
		$endescription=strip_tags($encontent);
		$endescription=str_replace("\n", '', $endescription); 
		$endescription=str_replace("\r", '', $endescription); 
		$endescription=str_replace("\t", '', $endescription);
		$endescription=mb_substr($endescription,0,200,'utf-8');
	}
	$content = concentwatermark_compatible($content);
	$encontent = concentwatermark_compatible($encontent);
