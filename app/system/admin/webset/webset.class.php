...
class webset extends admin {
	...
	function doseteditor(){
		...
		$configlist[] = 'gz_heazcsryxxlj'; 
		$configlist[] = 'gz_heazcsryxxljeeww'; 
		$configlist[] = 'gz_hemmttfffxz'; 
		$configlist[] = 'gz_hsjjquhaoo'; 
		$configlist[] = 'gz_hsjjquhaoossyyimgg'; 
		$configlist[] = 'gz_hsjjqccssimgg'; 
		$configlist[] = 'gz_hsjjquhaoogg'; 
		$configlist[] = 'gz_hemmttfffxzzxxzwzttt'; 
		$configlist[] = 'gz_hggxxwwg'; 
		$configlist[] = 'gz_hguanyuwwbdg'; 
		$configlist[] = 'gz_hguyoushibdg'; 
		$configlist[] = 'gz_hggsxinwwbdg'; 
		$configlist[] = 'gz_hemmttfffxzzxxzwz'; 
		$configlist[] = 'engz_hemmttfffxzzxxzwz'; 
		$configlist[] = 'engz_hemmttfffxzzxxzwzttt'; 
		$configlist[] = 'engz_webname'; 
		$configlist[] = 'gz_hsjjquenginggimgg'; 
		$configlist[] = 'gz_eenfootother'; 
		$configlist[] = 'engz_hsjjquhaoogg'; 
		$configlist[] = 'gz_headTelesszyxxlj'; 
